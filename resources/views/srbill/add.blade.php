...
<section class="content">
        <!-- Main row -->
        {!! Form::open(['action'=>'Srbills\SrbillsController@store','method'=>'POST']) !!}
        <div class="row">
          <!-- Left col -->
          <div class="col-md-8">
                    ...
                    <div class="box-body">
                          ...
                          <div class="form-group">
                              <div class="row">
                                  ...
                                  <div class="col-sm-8">
                                  {{form:: text('srbill_original_id','',['class'=>'form-control','placeholder'=>'Bill No'])}}
                                  </div>
                              </div>
                          </div>
                          <div class="form-group">
                        ...
                        <div class="box-body amount_details" id ='amt_details'>
                            <div class="form-group" id ="sub_tot">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                    {{form:: text('tot_amt','',['class'=>'form-control grandtotal','placeholder'=>'Item name'])}}
                                    </div>
                                </div>
                            </div>
                    </div>
