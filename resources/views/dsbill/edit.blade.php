...
<section class="content">
        <!-- Main row -->
        {!! Form::open(['action'=>['Dsbills\DsbillsController@update',$sbill->sbill_id],'method'=>'PUT']) !!}
        <div class="row">
          <!-- Left col -->
          <div class="col-md-8">
              ...
              <div class="box-body">
                <div class="table-responsive">
                  <table class="table no-margin" id="input_item">
                    ...
                    <tbody class="detail">
                    @php($i = 1)
                    @foreach ($sbill->dsbillitem as $sbitem)  
                    <tr>
                      <td>{{$i}}</td>
                      <td>
              ...
              <div class="box box-primary">
                    ...
                    <div class="box-body">
                          <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  {{form:: text('c_name',$sbill->creditor_name,['class'=>'form-control','placeholder'=>'Creditor Name'])}}
