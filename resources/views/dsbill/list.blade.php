    ...
    <div class="box">
        <div class="box-header with-border">
            <section class="content-header">
                ...
                <a class = 'breadcrumb' href='{{ action('Dsbills\DsbillsController@create') }}' style="float:right">
                  ...
                  <tr>
                    ...
                    <td class="text-left" style="padding:0px">
                        <div class='delete' style="display:inline;">
                            {!! Form::open(['class'=>'del','action'=>['Dsbills\DsbillsController@destroy',$sbill->sbill_id],'style'=>'display:inline;','method'=>'POST','id'=>$sbill->sbill_id]) !!}
                        ...
                        <div style="display:inline;float: right clear">
                          <a href="/dsbills/{{$sbill->sbill_id}}" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> </a>
                          <a href="/dsbills/{{$sbill->sbill_id}}/edit" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> </a>
                        </div>
                     </td>                      
                  </tr>
                 @php ($i++)
