                ...
                <div class="table-responsive">
                  <table class="table no-margin" id="input_item">
                    ...
                    <tr>
                        ...
                        <td> {{form:: text('i_cur_dp','',['class'=>'form-control','placeholder'=>'Quantity'])}}</td>
                        <td> {{form:: text('i_cur_dp','',['class'=>'form-control','placeholder'=>'Rate'])}}</td>
                        <td> {{form:: text('i_cur_dp','',['class'=>'form-control rate','placeholder'=>'Discount'])}}</td>
                        <td> {{form:: text('i_cur_dp','',['class'=>'form-control','placeholder'=>'Total'])}}</td>
                    </tr>
                    <tr>
                        <td>5</td>
              ...
              <div class="box-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            {{form:: label('item_name','Grand Total: ','',['class'=>'form-control '])}}
                            </div>
                            <div class="col-sm-8">
                    ...
                    <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4 text-center">
                                {{form:: label('item_name','Discount Amount: ','',['class'=>'form-control '])}}
                                </div>
                                <div class="col-sm-8">
                                {{form:: text('item_name','',['class'=>'form-control grandtotal','placeholder'=>'Item name'])}}
                                </div>
                     ...
                     <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4 text-center">
                                {{form:: label('item_name','Paid Amount: ','',['class'=>'form-control '])}}
                                </div>
                                <div class="col-sm-8">
                                {{form:: text('item_name','',['class'=>'form-control grandtotal','placeholder'=>'Item name'])}}
                                </div>
                     ...
                     <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4 text-center">
                                {{form:: label('item_name','Remaining Amount: ','',['class'=>'form-control '])}}
                                </div>
                                <div class="col-sm-8">
                                {{form:: text('item_name','',['class'=>'form-control grandtotal','placeholder'=>'Item name'])}}
                                </div>
              ...
              <div class="box box-primary">
                    ...
                    <div class="box-body">
                          ...
                          <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-4 text-center">
                                    {{form:: label('item_name','Type : ','',['class'=>'form-control'])}}
                                    </div>
                                    <div class="col-sm-8">
                                    {{form:: text('item_name','',['class'=>'form-control','placeholder'=>'Item name'])}}
                                    </div>
