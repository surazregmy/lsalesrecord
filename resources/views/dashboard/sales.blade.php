                  ...
                  <ul class="nav nav-stacked">
                    ...
                    <li>
                      <a href="#"><b>Sales Return </b><span class=" badge bg-orange">{{$sum_week['sr_bill_no']}}</span>
                          <span class="pull-right"><b>Rs. {{$sum_week['sr_total']}}</b></span>
                      </a>
                    </li>
                    <li>
              ...
              <div class="box box-widget">
                ...
                <div class="box-footer no-padding">
                  <ul class="nav nav-stacked">
                    ...
                    <li>
                      <a href="#"><b>Sales Return </b><span class=" badge bg-orange">{{$sum_month['sr_bill_no']}}</span>
                          <span class="pull-right"><b>Rs. {{$sum_month['sr_total']}}</b></span>
                      </a>
                    </li>
                    <li>
                  ...
                  <ul class="nav nav-stacked">
                    ...
                    <li>
                      <a href="#"><b>Sales Return </b><span class=" badge bg-orange">{{$sum_year['sr_bill_no']}}</span>
                          <span class="pull-right"><b>Rs. {{$sum_year['sr_total']}}</b></span>
                      </a>
                    </li>
                    <li>
