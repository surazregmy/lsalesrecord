        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-info">
              ...
              <!-- /.box-header -->
              {!! Form::open(['action'=>['Prbills\PrbillsController@update',$prbill->prbill_id],'method'=>'PUT']) !!}
              <div class="box-body">
                    ...
                    @php ($i = 1)
                     ...
                     <tr>
                            ...
                            <select name = "{{'item'.$i}}" class="select2 form-control" style="width: 100%";>
                                  <option value="<?php echo $prbitem->item_id?>"  selected="selected" >{{$prbitem->item[0]['item_name']}}</option>
                                      <?php foreach($items as $item): ?>
                                                 <option value="<?php echo $item['item_id'] ?>"><?php echo $item['item_name'];?></option>          
                                       <?php endforeach ?>
                                   </select>
                              </td>
                            <td> {{form:: text('quantity'.$i,$prbitem->quantity,['class'=>'form-control quantity','placeholder'=>'Quantity'])}}</td>
                            <td> {{form:: text('rate'.$i,$prbitem->rate,['class'=>'form-control rate','placeholder'=>'Rate'])}}</td>
                            <td> {{form:: text('total'.$i,$prbitem->total,['class'=>'form-control total','placeholder'=>'Total'])}}</td>
                            @php ($i++)
                        </tr>
                     @endforeach
                    </tbody>
          ...
          <div class="col-md-4">
              ...
              <div class="box-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                            {{form:: text('total_amount',$prbill->pr_total_amount,['class'=>'form-control grandtotal','placeholder'=>'Item name'])}}
                            </div>
                        </div>
                    </div>
            </div>
            <!-- /.box -->
              ...
              <div class="box box-primary">
                    ...
                    <div class="box-body">
                          <div class="form-group">
                              <div class="row">
                                  ...
                                  <div class="col-sm-8">
                                        ...
                                        <option value="{{$prbill->debtor->debtor_id}}"  selected="selected" >{{$prbill->debtor->debtor_name}}</option>
                          ...
                          <div class="form-group">
                              <div class="row">
                                  ...
                                  <div class="col-sm-8">
                                  {{form:: text('prbill_original_id',$prbill->prbill_original_id,['class'=>'form-control','placeholder'=>'Bill No'])}}
                                  </div>
                              </div>
                          </div>
                          <div class="form-group">
                              <div class="row">
                                  ...
                                  <div class="col-sm-8">
                                  {{form:: text('date_of_purchase',$prbill->pr_date_of_purchase_n,['class'=>'form-control bod-picker','placeholder'=>'date'])}}
                                  </div>
                              </div>
                          </div>
                          <div class="form-group">
                              <div class="row">
                                  ...
                                  <div class="col-sm-8">
                                  {{form:: text('entered_by',$prbill->pr_entered_by,['class'=>'form-control','readonly'])}}
                                  </div>
                              </div>
                          </div>
                    </div>
                    <!-- /.box-body -->
                    <div class="box-footer clearfix">
                            {{Form::hidden('prbill_old_id', $prbill->prbill_generated_id) }}
