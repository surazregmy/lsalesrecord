        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-info">
              ...
              <!-- /.box-header -->
              {!! Form::open(['action'=>'Prbills\PrbillsController@store','method'=>'POST']) !!}
              <div class="box-body">
              ...
              <div class="box box-primary">
                    ...
                    <div class="box-body">
                          ...
                          <div class="form-group">
                              <div class="row">
                                  <div class="col-sm-4 text-center">
                                  {{form:: label('prbill_original_id','Bill No: ','',['class'=>'form-control'])}}
                                  </div>
                                  <div class="col-sm-8">
                                  {{form:: text('prbill_original_id','',['class'=>'form-control','placeholder'=>'Bill No'])}}
                                  </div>
                              </div>
                          </div>
                          <div class="form-group">
