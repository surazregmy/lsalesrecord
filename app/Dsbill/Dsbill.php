...
class Dsbill extends Model
{
    ...
    public function dsbillitem(){
        return $this->hasMany('App\DsbillItem\DsbillItem','sbill_id','sbill_id');
    }
    ...
    public static function addSbill($request){
        ...
        $sbill->creditor_name = $request->input('c_name');
            ...
            for ($i=1; $i < count($_POST) -$no_of_params; $i+=5) { 
                ...
                if (!(in_array(null, $one_row))) {
                    ...
                    $data = array(
                        ...
                        DB::table('dsbill_items')->insert($data);
    ...
    public static function updateSbill($request,$id){
        ...
        try{
            ...
            DsbillItem :: where('sbill_id',$updated_id)->delete();
